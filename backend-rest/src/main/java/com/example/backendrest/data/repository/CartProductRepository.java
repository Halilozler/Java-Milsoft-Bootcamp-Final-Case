...
public interface CartProductRepository extends CrudRepository<CartProduct, Long> {
    ...
    void allDelete(@Param("cartId") long cartId);
    ...
    @Query("select sum(cp.salesQuantity) from CartProduct cp where cp.cart.cartId= :cartId")
    public Integer getCartProductSizeByCartId(@Param("cartId") long cartId);
